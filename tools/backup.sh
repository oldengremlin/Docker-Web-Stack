...
du -sh "$DEST"
echo
echo "УВАГА: secrets/ сюди НЕ потрапив — це паролі БД. Без них дампи"
echo "можна відновити, але контейнери не піднімуться. Зберігайте secrets/"
echo "окремо (менеджер паролів, зашифрований носій)."
